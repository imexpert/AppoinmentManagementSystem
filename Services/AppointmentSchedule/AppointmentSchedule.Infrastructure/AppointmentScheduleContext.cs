...
{
    public class AppointmentScheduleContext : DbContext, IUnitOfWork
    { 
        ...
        public AppointmentScheduleContext(DbContextOptions<AppointmentScheduleContext> options, IMediator mediator) : base(options)
        {
            _mediator = mediator ?? throw new ArgumentNullException(nameof(mediator));

            System.Diagnostics.Debug.WriteLine("AppointmentScheduleContext::ctor ->" + this.GetHashCode());
        }
